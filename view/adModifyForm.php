...
<?php foreach ($colocation as $item) :?>
        <div class="container">
            ...
            <input type="text" placeholder="Entrez le titre de votre annonce" id="adTitle" name="Titre" required value="<?=$item['Titre']?>">
            ...
            <img id="preview" src="<?=$item['Image']?>" href="<?=$item['Image']?>" alt="Preview Image" width="500px" height="500px" >
            ...
            <input type="text" placeholder="Entrez le lieu de la colocation" id="Localisation" name="Localisation" required value="<?=$item['Localisation']?>">

            <label for="adresse"><b>Adresse</b></label>
            <input type="text" placeholder="chemin de Gransson" id="adresse" name="Adresse" required value="<?=$item['Adresse']?>">

            <fieldset>
                <legend>Type d'habitation</legend>

                <div>
                    <input type="radio" id="Habitation" name="Habitation" value="Maison">
            ...
            <input type="number" placeholder="Nombres de pieces" id="nbPieces" name="Pièces" required value="<?=$item['Pièces']?>">
            <br><br>
